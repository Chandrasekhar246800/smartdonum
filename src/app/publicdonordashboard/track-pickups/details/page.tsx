      ...
      <div className="w-full max-w-2xl bg-white/90 rounded-3xl shadow-2xl border border-sky-100 p-6 sm:p-10 animate-fadeinup relative">
        {details.status === "cancelled" ? (
          ...
          <>
            ...
            <p className="text-sky-700 mb-4">Pickup Status: <span className={details.status === "accepted" ? "text-green-600" : "text-yellow-600"}>{details.status}</span></p>
            <div className="mb-6">
        ...
        <div className="mb-6 text-sm text-yellow-700 bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded">
          For your safety, the volunteer will show their NGO ID at pickup. Please verify their ID and match code: <span className="font-bold">{details.volunteer?.verificationId || "N/A"}</span>.
        </div>
