			...
			<div className="w-full max-w-2xl bg-white/90 rounded-3xl shadow-2xl border border-sky-100 p-6 sm:p-10 animate-fadeinup relative">
				   {d.status === 'cancelled' ? (
					   ...
					   <>
						   ...
						   <p className="text-sky-700 mb-4">Status: <span className={d.status === 'accepted' ? 'text-green-600' : 'text-yellow-600'}>{d.status}</span></p>
						   {/* Timeline */}
						   <div className="mb-6">
						   ...
						   <div className="mb-6 text-sm text-yellow-700 bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded">
							   Volunteer will show NGO ID at pickup. Verify Rahul’s ID and match code: <span className="font-bold">{d.volunteer && d.volunteer.verificationId ? d.volunteer.verificationId : "N/A"}</span> at pickup.
						   </div>
