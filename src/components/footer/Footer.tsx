...
export default function Footer() {
  ...
  if (["aboutUs", "faq", "contactUs", ""].includes(pathname.split("/")[1])) {
    return (
      <>
      <footer className="absolute rounded-2xl sm:mt-16 flex-shrink-0 bg-gradient-to-r from-sky-100 via-white to-amber-100 bg-opacity-90 z-10 w-full  md:w-[95%] md:ml-10" style={{marginTop: '1rem'}}>
