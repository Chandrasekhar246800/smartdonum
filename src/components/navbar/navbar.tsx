    ...
    <>
      <nav className="w-full flex items-center justify-between px-4 py-3 bg-sky-100/80 backdrop-blur-sm shadow-lg fixed top-0 left-0 z-30">
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => router.push('/')}>
          <img src="/images/logo.png" alt="SmartDonum Logo" className="md:h-[70px] md:w-[70px] w-[50px] h-[50px] object-contain" style={{ display: 'block' }} />
        ...
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-72 bg-white shadow-2xl z-50 transform md:hidden transition-transform duration-300 ease-in-out">
            ...
            <div className="flex flex-col p-4 space-y-3">
              ...
              <button className="text-left w-full px-4 py-3 text-lg text-sky-700 font-semibold hover:bg-sky-50 rounded-lg transition-colors" onClick={() => handleNavigate('/aboutUs')}>About Us</button>
